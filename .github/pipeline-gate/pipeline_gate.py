...
# totals — 18 + 630 + 177 = 825, which is the figure CLAUDE.md and
# docs/testing.md carry and the sum docs/testing.md points at ("648 and 177
# summing to 825", 648 being the architecture and unit stages together).
#
