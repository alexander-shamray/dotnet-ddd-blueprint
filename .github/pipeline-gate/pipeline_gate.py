...
# totals — 18 + 653 + 188 = 859, which is the figure CLAUDE.md and
# docs/testing.md carry and the sum docs/testing.md points at ("671 and 188
# summing to 859", 671 being the architecture and unit stages together).
#
