...
# totals — 18 + 635 + 177 = 830, which is the figure CLAUDE.md and
# docs/testing.md carry and the sum docs/testing.md points at ("653 and 177
# summing to 830", 653 being the architecture and unit stages together).
#
