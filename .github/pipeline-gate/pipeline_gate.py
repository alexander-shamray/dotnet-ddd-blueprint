...
# totals — 18 + 645 + 187 = 850, which is the figure CLAUDE.md and
# docs/testing.md carry and the sum docs/testing.md points at ("663 and 187
# summing to 850", 663 being the architecture and unit stages together).
#
