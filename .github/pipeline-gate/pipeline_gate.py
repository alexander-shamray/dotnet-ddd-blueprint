...
# totals — 18 + 633 + 177 = 828, which is the figure CLAUDE.md and
# docs/testing.md carry and the sum docs/testing.md points at ("651 and 177
# summing to 828", 651 being the architecture and unit stages together).
#
