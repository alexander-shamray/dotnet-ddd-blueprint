...
4. **File.** One issue per survivor, most severe first, in the house body form:
   ...
   `bash .claude/scripts/gh-issue-create.sh security <severity> sweep` on stdin**
   ...
   the checkout, refuses a kind, a severity or a route outside its three closed sets, refuses a
