...
/// <see cref="ProductConfiguration"/>'s <c>ComplexProperty</c> does for
/// columns, for the other persisted format — and in the same assembly, for the
/// same reason: the domain type must not know about either.
/// </summary>
/// <remarks>
