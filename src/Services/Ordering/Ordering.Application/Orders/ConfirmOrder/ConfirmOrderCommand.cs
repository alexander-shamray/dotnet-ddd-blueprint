...
/// of §11.4 has two callers to tell apart. This one has a single caller — the
/// saga, over <c>ordering-commands</c> — and no endpoint maps it. Adding the
/// field would state a distinction the code cannot make, and a discriminator
/// with one value is the kind of thing a later reader completes by adding the
/// missing endpoint.
/// <para>
