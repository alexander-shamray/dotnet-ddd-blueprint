...
/// slice be tested — §12.4's handler tests seed rows directly — and what
/// keeps PR-20 to the handler it is named for.
/// <para>
/// The composite key is <c>(ProductId, Currency)</c> because that is exactly
/// what the reader's <c>WHERE</c> seeks on, and <c>LastSeenAt</c> exists
/// before its first reader: it is the out-of-order guard §6.6 requires, and a
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LastSeenAt = table.Column<DateTimeOffset>(type: "datetimeoffset(7)", nullable: false)
            },
            constraints: table =>
            {
