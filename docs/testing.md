...
> here — the 822 is summed from `dotnet test` output, and mixing the two is how
> this callout first came to claim 72 and 82. Quote what ran.
>
> Across the solution the split is **645 and 177 of 822**, and the fast half
...
on this repository they are **18**, **627** and **177**, summing to the 822 the
...
> counts above are what makes the difference visible — 645 and 177 summing to
> 822 — so whoever writes the staged pipeline should assert a floor on each
