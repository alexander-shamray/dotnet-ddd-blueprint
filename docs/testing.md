...
> first came to claim 72 and 82. The 1,093 is summed from `dotnet test`
...
>
> Across the solution the split is **869 and 224 of 1,093**, and the fast half
...
on this repository they are **18**, **851** and **224**, summing to the 1,093
...
> counts above are what makes the difference visible — 869 and 224 summing to
> 1,093 — so whoever writes the staged pipeline should assert a floor on each
