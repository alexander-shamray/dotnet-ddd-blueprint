...
> here — the 854 is summed from `dotnet test` output, and mixing the two is how
> this callout first came to claim 72 and 82. Quote what ran.
>
> Across the solution the split is **667 and 187 of 854**, and the fast half
...
on this repository they are **18**, **649** and **187**, summing to the 854 the
...
> counts above are what makes the difference visible — 667 and 187 summing to
> 854 — so whoever writes the staged pipeline should assert a floor on each
