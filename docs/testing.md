...
> here — the 935 is summed from `dotnet test` output, and mixing the two is how
> this callout first came to claim 72 and 82. Quote what ran.
>
> Across the solution the split is **739 and 196 of 935**, and the fast half
...
on this repository they are **18**, **721** and **196**, summing to the 935 the
...
> counts above are what makes the difference visible — 739 and 196 summing to
> 935 — so whoever writes the staged pipeline should assert a floor on each
