...
> here — the 912 is summed from `dotnet test` output, and mixing the two is how
> this callout first came to claim 72 and 82. Quote what ran.
>
> Across the solution the split is **722 and 190 of 912**, and the fast half
...
on this repository they are **18**, **704** and **190**, summing to the 912 the
...
> counts above are what makes the difference visible — 722 and 190 summing to
> 912 — so whoever writes the staged pipeline should assert a floor on each
