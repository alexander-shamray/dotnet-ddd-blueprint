...
> first came to claim 72 and 82. The 1,109 is summed from `dotnet test`
...
>
> Across the solution the split is **872 and 237 of 1,109**, and the fast half
...
on this repository they are **18**, **854** and **237**, summing to the 1,109
...
> counts above are what makes the difference visible — 872 and 237 summing to
> 1,109 — so whoever writes the staged pipeline should assert a floor on each
