...
> first came to claim 72 and 82. The 1,113 is summed from `dotnet test`
...
>
> Across the solution the split is **874 and 239 of 1,113**, and the fast half
...
on this repository they are **18**, **856** and **239**, summing to the 1,113
...
> counts above are what makes the difference visible — 874 and 239 summing to
> 1,113 — so whoever writes the staged pipeline should assert a floor on each
