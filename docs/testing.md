...
> first came to claim 72 and 82. The 1,111 is summed from `dotnet test`
...
>
> Across the solution the split is **874 and 237 of 1,111**, and the fast half
...
on this repository they are **18**, **856** and **237**, summing to the 1,111
...
> counts above are what makes the difference visible — 874 and 237 summing to
> 1,111 — so whoever writes the staged pipeline should assert a floor on each
