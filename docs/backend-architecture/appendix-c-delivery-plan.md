...
turns the window from *until the next rollout* into *within the hour*. That is
what earns the row, and the size of the diff is not: a second job in a workflow
