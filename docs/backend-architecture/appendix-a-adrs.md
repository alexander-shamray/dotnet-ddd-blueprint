...
> [ADR-041](#adr-041--the-markers-delete-identifies-a-row-by-a-rowversion-not-a-timestamp),
...
**Why.** [ADR-039](#adr-039--the-markers-purge-asks-the-claim-rather-than-out-counting-it)
...
**Why.**
[ADR-042](#adr-042--the-deployed-realm-is-checked-at-deploy-time) reads a
